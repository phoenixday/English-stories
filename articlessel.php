...
<b><?echo $_SESSION['login'];?> оставил комментарий в <?echo count($_SESSION['articles']);?> темах.</b>
<form method = 'post'>
<div id = 'articles'>
<?if (isset($_SESSION['articles']))foreach($_SESSION['articles'] as $value) {echo $value;}?>
</div>
</form>
</div>
